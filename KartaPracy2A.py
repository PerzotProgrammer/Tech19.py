...
c = int(input("Liczba3: "))
d = int(input("Liczba4: "))
if a < b and a < c and a < d: print("Najmniejsza liczba to 'Liczba1'")
elif b < a and b < c and b < d : print("Najmniejsza liczba to 'Liczba2'")
elif c < a and c < b and c < d : print("Najmniejsza liczba to 'Liczba3'")
elif d < a and d < b and d < c : print("Najmniejsza liczba to 'Liczba4'")
